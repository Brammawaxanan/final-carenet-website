...
const SubscribePage = () => {
  ...
  const handleSubscribe = (planName, planPrice) => {
    ...
    console.log('Navigating to payment page for plan:', planName)
    ...
    navigate('/payment/subscription', {
      state: {
        ...
        planName: planName,
        planPrice: planPrice,
        amount: parseFloat(planPrice.replace(/[^0-9.]/g, '')), // Extract numeric value from price string
        serviceType: `${planName} Subscription`,
      ...
      <div className="flex justify-center">
        ...
        {plans.map((plan, index) => (
          ...
          >
            ...
            <button
              onClick={() => handleSubscribe(plan.name.toUpperCase(), plan.price)}
              disabled={currentSubscription?.isSubscribed && plan.name === 'Premium'}
