...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (typeof response.isSubscribed === 'boolean') {
        localStorage.setItem('isSubscribed', JSON.stringify(response.isSubscribed))
      } else if (typeof response.isPremium === 'boolean') {
        localStorage.setItem('isSubscribed', JSON.stringify(response.isPremium))
      }
      
      // Redirect to appropriate dashboard based on role
      if (response.role.toLowerCase() === 'caregiver') {
